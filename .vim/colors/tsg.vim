" Vim color file - tsg
" Generated by http://bytefluent.com/vivify 2014-06-22
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Function guifg=#deac6f guibg=NONE guisp=NONE gui=NONE ctermfg=179 ctermbg=NONE cterm=NONE
hi FoldColumn guifg=#dca3a3 guibg=#464646 guisp=#464646 gui=NONE ctermfg=181 ctermbg=238 cterm=NONE
hi PreProc guifg=#d7af5f guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
"hi PreProc guifg=#f7dcc1 guibg=NONE guisp=NONE gui=bold ctermfg=223 ctermbg=NONE cterm=bold
...
hi pythonbuiltin guifg=#968765 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi phpstringdouble guifg=#e6d7b5 guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#e6d7b5 guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi javascriptstrings guifg=#e6d7b5 guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi htmlstring guifg=#e6d7b5 guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi phpstringsingle guifg=#e6d7b5 guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi stringdelimiter guifg=#4e2267 guibg=NONE guisp=NONE gui=NONE ctermfg=53 ctermbg=NONE cterm=NONE
hi rubyregexp guifg=#b1debf guibg=NONE guisp=NONE gui=NONE ctermfg=151 ctermbg=NONE cterm=NONE
hi string guifg=#8e4cad guibg=NONE guisp=NONE gui=NONE ctermfg=97 ctermbg=NONE cterm=NONE
hi constant guifg=#2164d0 guibg=NONE guisp=NONE gui=NONE ctermfg=26 ctermbg=NONE cterm=NONE
hi normal guifg=#b8a6e9 guibg=#151215 guisp=#151215 gui=NONE ctermfg=183 ctermbg=233 cterm=NONE
hi rubyinstancevariable guifg=#bbff7f guibg=NONE guisp=NONE gui=NONE ctermfg=156 ctermbg=NONE cterm=NONE
hi rubyclass guifg=#9a8328 guibg=NONE guisp=NONE gui=NONE ctermfg=94 ctermbg=NONE cterm=NONE
hi identifier guifg=#b1ef88 guibg=NONE guisp=NONE gui=NONE ctermfg=156 ctermbg=NONE cterm=NONE
hi comment guifg=#6a8972 guibg=NONE guisp=NONE gui=italic ctermfg=65 ctermbg=NONE cterm=NONE
hi rubyregexpdelimiter guifg=#4e6355 guibg=NONE guisp=NONE gui=NONE ctermfg=65 ctermbg=NONE cterm=NONE
hi rubyregexpspecial guifg=#84a498 guibg=NONE guisp=NONE gui=NONE ctermfg=109 ctermbg=NONE cterm=NONE
hi rubypredefinedidentifier guifg=#2bdcdf guibg=NONE guisp=NONE gui=NONE ctermfg=44 ctermbg=NONE cterm=NONE
hi function guifg=#4b48fa guibg=NONE guisp=NONE gui=NONE ctermfg=63 ctermbg=NONE cterm=NONE
hi directory guifg=#795bdb guibg=NONE guisp=NONE gui=NONE ctermfg=98 ctermbg=NONE cterm=NONE
hi rubysymbol guifg=#d4d650 guibg=NONE guisp=NONE gui=NONE ctermfg=185 ctermbg=NONE cterm=NONE
hi rubycontrol guifg=#c7c54c guibg=NONE guisp=NONE gui=NONE ctermfg=185 ctermbg=NONE cterm=NONE
hi rubyidentifier guifg=#bbff7f guibg=NONE guisp=NONE gui=NONE ctermfg=156 ctermbg=NONE cterm=NONE
hi condtional guifg=#8fffff guibg=NONE guisp=NONE gui=NONE ctermfg=123 ctermbg=NONE cterm=NONE
hi pythonimport guifg=#917387 guibg=NONE guisp=NONE gui=NONE ctermfg=96 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#c0f0d0 guibg=NONE guisp=NONE gui=NONE ctermfg=194 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#917387 guibg=NONE guisp=NONE gui=NONE ctermfg=96 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#a2a360 guibg=NONE guisp=NONE gui=NONE ctermfg=143 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#917387 guibg=NONE guisp=NONE gui=NONE ctermfg=96 ctermbg=NONE cterm=NONE
hi gutter guifg=#101a1a guibg=#98bea2 guisp=#98bea2 gui=NONE ctermfg=234 ctermbg=108 cterm=NONE
...
hi htmlitalic guifg=#a6d1b5 guibg=#1a1f1f guisp=#1a1f1f gui=italic ctermfg=151 ctermbg=234 cterm=NONE
hi htmlboldunderlineitalic guifg=#a6d1b5 guibg=#1a1f1f guisp=#1a1f1f gui=bold,italic,underline ctermfg=151 ctermbg=234 cterm=bold,underline
hi htmlbolditalic guifg=#a6d1b5 guibg=#1a1f1f guisp=#1a1f1f gui=bold,italic ctermfg=151 ctermbg=234 cterm=bold
hi htmlunderlineitalic guifg=#a6d1b5 guibg=#1a1f1f guisp=#1a1f1f gui=italic,underline ctermfg=151 ctermbg=234 cterm=underline
hi htmlbold guifg=#a6d1b5 guibg=#1a1f1f guisp=#1a1f1f gui=bold ctermfg=151 ctermbg=234 cterm=bold
hi htmlboldunderline guifg=#a6d1b5 guibg=#1a1f1f guisp=#1a1f1f gui=bold,underline ctermfg=151 ctermbg=234 cterm=bold,underline
hi htmlunderline guifg=#a6d1b5 guibg=#1a1f1f guisp=#1a1f1f gui=underline ctermfg=151 ctermbg=234 cterm=underline
